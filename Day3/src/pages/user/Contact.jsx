...
const Contact = () => {
  return (
    <div>
       <section className="text-gray-600 bg-yellow-100 body-font relative">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-gary-900 bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-200 rounded text-lg">Send</button>
        </div>
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a className="text-gray-900">GiftWonders@email.com</a>
          <p className="leading-normal my-5">Coimbatore,Tamilnadu
          </p>
